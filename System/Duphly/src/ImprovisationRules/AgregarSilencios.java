 ...
 * @author Gaston
 */
public class AgregarSilencios extends GenericImprovisationRule  {
    ...
    private CompleteBlockFilterRule crearReglaCompletaDeFiltroDeCompases(){
        ...
        cbfr = new CompleteBlockFilterRule(2,this.crearCondicionDeFiltroDeCompases(),null,40.0,null,null,false);
        return cbfr;
    }
