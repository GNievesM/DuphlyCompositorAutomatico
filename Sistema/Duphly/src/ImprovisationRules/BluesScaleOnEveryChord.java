 ...
 * @author gasto_000
 */
public class BluesScaleOnEveryChord extends GenericImprovisationRule {
    ...
    public List<Note> GenerateImprovisation(List<Chord> base) {
        ...
        for (int i = 0; i < base.size(); i++) {
             if(base.get(i).GetDuration()== ConstantsDefinition.getInstance().GetBlackFigure()*8){
                ...
                result.add(Util.CalculateNoteForChord(base.get(i), 3, ((double) base.get(i).GetDuration())/16, 4));
                result.add(Util.CalculateNoteForChord(base.get(i), 4, ((double) base.get(i).GetDuration())/16, 4));
                result.add(Util.CalculateNoteForChord(base.get(i), 3, ((double) base.get(i).GetDuration())/16, 4));
                result.add(Util.CalculateNoteForChord(base.get(i), 2, ((double) base.get(i).GetDuration())/16, 4));
                result.add(Util.CalculateNoteForChord(base.get(i), 1, ((double) base.get(i).GetDuration())/16, 4));
                result.add(Util.CalculateNoteForChord(base.get(i), 0,((double) base.get(i).GetDuration())/16, 4));
            ...
            if(base.get(i).GetDuration()== ConstantsDefinition.getInstance().GetBlackFigure()*4){
                result.add(Util.CalculateNoteForChord(base.get(i), 0,((double) base.get(i).GetDuration())/8, 4));
                ...
                result.add(Util.CalculateNoteForChord(base.get(i), 4, ((double) base.get(i).GetDuration())/8, 4));
                result.add(Util.CalculateNoteForChord(base.get(i), 3, ((double) base.get(i).GetDuration())/8, 4));
                result.add(Util.CalculateNoteForChord(base.get(i), 2, ((double) base.get(i).GetDuration())/8, 4));
                result.add(Util.CalculateNoteForChord(base.get(i), 1, ((double) base.get(i).GetDuration())/8, 4));
            }
            if(base.get(i).GetDuration()== ConstantsDefinition.getInstance().GetBlackFigure()*2){
                result.add(Util.CalculateNoteForChord(base.get(i), 0,((double) base.get(i).GetDuration())/4, 4));
                result.add(Util.CalculateNoteForChord(base.get(i), 1,((double) base.get(i).GetDuration())/4, 4));
                result.add(Util.CalculateNoteForChord(base.get(i), 2,((double) base.get(i).GetDuration())/4, 4));
                result.add(Util.CalculateNoteForChord(base.get(i), 3, ((double) base.get(i).GetDuration())/4, 4));
            }
            if(base.get(i).GetDuration()== ConstantsDefinition.getInstance().GetBlackFigure()){
                result.add(Util.CalculateNoteForChord(base.get(i), 0,((double) base.get(i).GetDuration())/2, 4));
                result.add(Util.CalculateNoteForChord(base.get(i), 1,((double) base.get(i).GetDuration())/2, 4));
            }
            if(base.get(i).GetDuration()== ConstantsDefinition.getInstance().GetBlackFigure()/2){
                result.add(Util.CalculateNoteForChord(base.get(i), 0,((double) base.get(i).GetDuration()), 4));
            }
         //   result.add(Util.CalculateNoteForChord(base.get(i), 3, ((double) base.get(i).GetDuration())/8, 4));
           // result.add(Util.CalculateNoteForChord(base.get(i), 2, ((double) base.get(i).GetDuration())/8, 4));
           // result.add(Util.CalculateNoteForChord(base.get(i), 1, ((double) base.get(i).GetDuration())/8, 4));
