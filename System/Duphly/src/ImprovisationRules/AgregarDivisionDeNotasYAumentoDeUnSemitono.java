...
public class AgregarDivisionDeNotasYAumentoDeUnSemitono
  extends GenericImprovisationRule {
  ...
  private CompleteModificationRule crearReglaCompletaDeModificacionDeSubirTono() {
    ...
    cr =
      new CompleteModificationRule(
        this.crearCondicionModificacionUnTono(),
        null,
  ...
  private GuaranteedCondition crearGarantiaModifiacionAumentoSemitono() {
    return new GuaranteeIntervalBetweenNotes(
