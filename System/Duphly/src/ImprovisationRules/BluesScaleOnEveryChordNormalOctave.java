 ...
 * @author gasto_000
 */
public class BluesScaleOnEveryChordNormalOctave
      ...
      if (
        ...
        result.add(
          Util.CalculateNoteForChord(
            base.get(i),
            0,
            ((double) base.get(i).GetDuration()) / 16,
            6
          )
        );
        result.add(
      ...
      if (
        ...
        result.add(
          Util.CalculateNoteForChord(
            base.get(i),
            0,
            ((double) base.get(i).GetDuration()) / 8,
            6
          )
        );
        result.add(
      ...
      if (
        ...
        result.add(
          Util.CalculateNoteForChord(
            base.get(i),
            0,
            ((double) base.get(i).GetDuration()) / 4,
            6
          )
        );
        result.add(
      ...
      if (
        ...
        result.add(
          Util.CalculateNoteForChord(
            base.get(i),
            0,
            ((double) base.get(i).GetDuration()) / 2,
            6
          )
        );
        result.add(
