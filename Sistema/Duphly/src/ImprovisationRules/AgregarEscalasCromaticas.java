...
public class AgregarEscalasCromaticas extends GenericImprovisationRule  {
    ...
    private CompleteBlockFilterRule crearReglaCompletaDeFiltroDeCompases(){
        ...
        cbfr = new CompleteBlockFilterRule(1,this.crearCondicionDeFiltroDeCompases(),null,100.0,null,null,false);
        return cbfr;
    }
    ...
    private CompleteExcerptFilterRule crearReglaDeFiltroDePasajesCompleta(){
        ...
        cefr = new CompleteExcerptFilterRule(null, 100.0, true, null, null, null, 1, 1, this.crearCondicionDePasajes(), 2, false);
        return cefr;
    }
    ...
    private ExcerptConditionSelector crearCondicionDePasajes(){
        ...
        return new DifferenceBeetweenNotes(HelperCustomRule.ComparadorIgual(),4,1);
