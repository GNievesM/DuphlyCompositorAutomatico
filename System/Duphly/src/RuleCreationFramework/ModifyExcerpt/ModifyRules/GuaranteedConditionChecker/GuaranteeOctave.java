 ...
 * @author Gaston
 */
public class GuaranteeOctave extends GuaranteedCondition implements IFitnessEvaluable{
    CheckOctave c;
    Comparador comp;
    int diffNumber ;
    List<Note> melody;
   ...
   /* @Override
    ...
    private double calculateDifferenceSum(){
        ...
        for (int i = notePositionStart; i < notePositionEnd-1; i++) {
            ...
            if(comp.esIgual() && octave == this.diffNumber || comp.esMayor() && octave > this.diffNumber || comp.esMenor() && octave < this.diffNumber)
