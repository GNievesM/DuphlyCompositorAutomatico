 ...
 * @author Gaston
 */
public class AgregarSilencios40porciento extends GenericImprovisationRule  {
    ...
    private CompleteBlockFilterRule crearReglaCompletaDeFiltroDeCompases(){
        ...
        cbfr = new CompleteBlockFilterRule(2,this.crearCondicionDeFiltroDeCompases(),null,100.0,null,null,false);
        return cbfr;
    }
    ...
    private CompleteModificationRule crearReglaCompletaDeModificacion(){
        ...
        cr = new CompleteModificationRule(null,
                                          null,
