 ...
 * @author Gaston
 */
public class AgregarDivisionDeNotasYAumentoDeUnSemitono extends GenericImprovisationRule  {

    @Override
    public Pair<List<Note>,List<Chord>> VerifyAndCorrectImprovisation(List<Note> improvisation, List<Chord> base) {
        
        return this.GenerarMelodia(this.crearReglaCompleta(), improvisation, base);
    ...
    private CompleteBlockFilterRule crearReglaCompletaDeFiltroDeCompases(){
        ...
        cbfr = new CompleteBlockFilterRule(1,this.crearCondicionDeFiltroDeCompases(),null,40.0,null,null,false);
        return cbfr;
    }
    ...
    private ModifyExcerpt crearContenedorDeModificacionesAAplicarse(){
        ...
        me.addModification(this.crearReglaCompletaDeModificacionDeSubirTono());
        return me;
    }
    ...
    private CompleteModificationRule crearReglaCompletaDeModificacion(){
     ...
     private CompleteModificationRule crearReglaCompletaDeModificacionDeSubirTono(){
        CompleteModificationRule cr;
        cr = new CompleteModificationRule(this.crearCondicionModificacionUnTono(),
                                          null,
                                          this.crearCambioParaModificarUnTono(),
                                          null,100);
        return cr;
    }
    private GuaranteedCondition crearGarantiaModifiacion(){
     ...
     private GuaranteedCondition crearGarantiaModifiacionAumentoSemitono(){
        //return new GuaranteeDifferenceBetweenNotes(HelperCustomRule.ComparadorMayor(),3);
        
       return new GuaranteeIntervalBetweenNotes(HelperCustomRule.ComparadorIgual(),0);
      ...
      private ModificationCondition crearCondicionModificacionUnTono(){
     //  return new CheckOctave(HelperCustomRule.ComparadorIgual(),5);        
       ...
       // return new CheckTimesANoteAppear(dummyNote, true, 3,  HelperCustomRule.ComparadorMayor());
        ...
        return new DifferenceBetweenNotes(HelperCustomRule.ComparadorIgual(),0);
   ...
   private SpecificModification crearCambioParaModificarUnTono(){
      
       
        return new MoveDemiTones(false,1);
   }
